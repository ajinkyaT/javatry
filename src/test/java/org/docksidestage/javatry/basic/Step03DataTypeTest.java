...
public class Step03DataTypeTest extends PlainTestCase {
    ...
    public void test_datatype_object() {
        ...
        log(sea); // your answer? => hangar , private class variables cannot be used outside so need to assign public class method
                    // to make it available inside the bigger class.
    }
